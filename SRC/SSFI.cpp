...
* * * * * * * * * * * * *  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *  * 
*                           Last Modified time: 2017-04-11 18:34:59                                     *            
*  * * * * * * * * * * * *  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
...
int main(){
	...
	postFoam pf=postFoam("test_model");
	...
	pf.boundary_pressure(0.005);

	pf.ESSI_input_pressure_load(122);    // 122 is the allowable surface load beginning ID in RealESSI input for this case, because imposed motion take up some load ID. 
